...
├── pyproject.toml               # 0.1.15; wheel force-includes both pins sets, the G2 container capture, ingest_corpus.py + estate.py
├── docs/
...
├── tests/                       # root suite: 176 tests across 9 modules (CI adds corpus 530 — its job label re-set 494 → 530 at CP-105, the release that lifted `.github/`; the runner collects 529 passed + 1 skipped, the demo-thirty pin being local — + mcp-service 164)
