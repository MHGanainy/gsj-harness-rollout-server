...
├── tests/                       # root suite: 176 tests across 9 modules (corpus collects 628 — source CI 624 passed and 4 skipped with fixture attribution inferred from source because quiet logs omit reasons — and mcp-service 256; historical job labels remain 541/164)
...
```
pip install -e ".[dev]"
pytest -q                                  # the root suite: 176 (corpus: .venv/bin/python -m pytest -q estate/corpus/tests → 628 collected; pass/skip split depends on available live fixtures)
