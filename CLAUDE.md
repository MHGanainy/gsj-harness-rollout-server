...
│   ├── decisions/               # ADRs (0001–0033), one file per decision, append-only — UNTRACKED since CP-48
...
├── tests/                       # root suite: 176 tests across 9 modules (CI adds corpus 109 + mcp-service 107)
