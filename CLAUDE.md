...
├── pyproject.toml               # 0.1.8; wheel force-includes both pins sets, the G2 container capture, ingest_corpus.py + estate.py
├── docs/
