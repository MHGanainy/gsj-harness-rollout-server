...
| `decisions/` | The ADRs, append-only, Context → Decision → Consequence (ADR-0001–0026 at CP-46; ADR-0027–0043 since) | anyone asking "why is it built this way" | private |
