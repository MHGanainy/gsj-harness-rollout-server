...
**[CP-85] The audit’s phase 3 — release candidate 0.1.8.** Row 80 now asserts ADR-0037’s supported writer/loader/package-reader/real-Compose round trips and apostrophe refusal before replacing the file; no skip, xfail or writer relaxation. The full local suites pass: root 176, corpus 291, MCP 164; collection independently confirms all three and row 79’s four workflow labels now agree. Core remains 2,034 lines, checks 528; frozen source is unchanged. The deprecated entry is retained in 0.1.8: its earliest-removal bound remains 0.1.8, an eligibility floor rather than a deadline. The installed-artifact, publication and image-dependent consumer outcomes follow in the release record; B01/B02/B03/B04/B05/B06/B16 remain consumer-open until those proofs complete. No H200 or later-phase work.
